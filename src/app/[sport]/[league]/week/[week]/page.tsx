    ...
    return <CalendarComponent {...{sport, league, scoreboard }} header={
        <>
            ...
            <p className="flex gap-2">
                <Link href={`/${sport}/${league}/week/${parseInt(week)-1}`} className="text-blue-500 hover:underline">Previous</Link>
                <Link href={`/${sport}/${league}/week/${parseInt(week)+1}`} className="text-blue-500 hover:underline">Next</Link>
            </p>
        </>
    }/>;
}
